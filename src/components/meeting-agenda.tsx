...
export function MeetingAgenda({ roomId, agenda, updateAgenda }: MeetingAgendaProps) {
    ...
    <div className="space-y-4">
      <div className="flex space-x-2">
        <div className="flex-grow">
          <Label htmlFor="newTopic" className="sr-only">New Topic</Label>
          <Input
            id="newTopic"
        ...
        <div className="w-24">
          <Label htmlFor="newDuration" className="sr-only">Duration (minutes)</Label>
          <Input
            id="newDuration"
            type="number"
            placeholder="Minutes"
